...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://pghiptyrrqxeysyglyfj.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_r8wUIMbf8uW1xDIrOiPmlA_AjPNDVmI';
...
<nav class="bottombar" id="bottombar" role="navigation" aria-label="Main tabs">
  ...
  <a href="products.html" class="bottombar-tab" data-page="products">
    <span class="bottombar-tab-icon">📦</span><span>Products</span>
  </a>
</nav>`;
  ...
  function currentPageKey() {
    ...
    if (p.endsWith('products.html')) return 'products';
    return 'main';
  }
